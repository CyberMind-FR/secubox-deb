...
### Instructions pour Codex dans VSCode
...
|----------|---------|-------------|------------|
| 1 | `.Codex/WIP.md` | Travail en cours, prochain item | **Toujours en premier** |
| 2 | `.Codex/TODO.md` | Backlog priorisé par phase | Pour planifier |
| 3 | `.Codex/HISTORY.md` | Historique des changements | Pour contexte |
| 4 | `.Codex/MIGRATION-MAP.md` | État modules (✅/🔄/⬜) | Pour status |
| 5 | `.Codex/PATTERNS.md` | Patterns RPCD→FastAPI | Pour coder |
| 6 | `.Codex/MODULE-COMPLIANCE.md` | Règles conformité | **Obligatoire avant code** |
...
| `.Codex/QUICKSHEET-REFERENCE.md` | Quick ref commandes | Pour commandes |
| `.Codex/DESIGN-CHARTER.md` | Charte UI/UX (C3BOX hermétique) | Pour frontend |
| `.Codex/WEBUI-PANEL-GUIDELINES.md` | **Look & feel DÉFAUT des webui de gestion des modules** (cyan hybrid-dark, Courier Prime, emoji ; réf. `/certs/`) | Avant tout panel/admin webui |
| `.Codex/WIKI-STYLE-GUIDE.md` | Style documentation | Pour docs |
| `.Codex/NOTES.md` | Notes de session | Pour contexte additionnel |
...
3. Mettre à jour les fichiers `.Codex/` :
...
```
secubox-deb/
├── .Codex/                    ← Suivi de projet (lire en premier)
...
- Cocher `✅` dans `.Codex/MIGRATION-MAP.md`
- Mettre à jour `.Codex/WIP.md` (déplacer vers "Fait", pointer le suivant)
- Appender à `.Codex/HISTORY.md` avec la date
...
Codex (deux terminaux) peuvent travailler simultanément sur deux issues
...
1. **`.Codex/HISTORY.md`** — ajouter entrée datée
2. **`.Codex/WIP.md`** — déplacer "fait", pointer le suivant
3. **`.Codex/MIGRATION-MAP.md`** — cocher `✅` si module complété
