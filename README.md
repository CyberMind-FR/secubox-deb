...
| Metric | Value |
|--------|-------|
| ![Packages](https://img.shields.io/badge/Debian_Packages-168-blue?logo=debian) | 139 `.deb` packages |
| ![Migration](https://img.shields.io/badge/Migration-81%25-brightgreen) | 131/139 modules migrated |
| ![APIs](https://img.shields.io/badge/API_Endpoints-3001+-informational) | FastAPI + JWT auth |
