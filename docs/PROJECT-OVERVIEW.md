...
# SecuBox — Project Overview (long form)

> Moved out of [`README.md`](../README.md) by #1188 so the README can stay a
> quick start. Nothing was deleted — this is the previous README content:
> flagship programmes, release history, full feature list, CTL grammar,
...
| Metric | Value |
|--------|-------|
| ![Packages](https://img.shields.io/badge/Debian_Packages-180-blue?logo=debian) | 139 `.deb` packages |
| ![Migration](https://img.shields.io/badge/Migration-77%25-brightgreen) | 131/139 modules migrated |
