...
func TestWidgetRadioConditionnelAuRadioBase(t *testing.T) {
	fn := template.FuncMap{
		...
		"decalage":    func(n int) string { return "" }, "urlembed": func(s string) string { return s }, "vignetteVideo": func(string) string { return "" }, "objetMediaURL": func(string) string { return "" },
	}
