...
async function callPolicies(params) {
    return sbxFetch('/api/v1/cdn/policies', params, 'GET');
}

async function callExclusions(params) {
    return sbxFetch('/api/v1/cdn/exclusions', params, 'GET');
}
...
async function callRemoveExclusion(params) {
    return sbxFetch('/api/v1/cdn/remove_exclusion', params, 'POST');
}
