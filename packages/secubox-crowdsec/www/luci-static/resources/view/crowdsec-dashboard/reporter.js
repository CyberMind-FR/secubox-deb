...
async function callHistory(params) {
    return sbxFetch('/api/v1/hub/history', params, 'GET');
}

async function callCheckIp(params) {
    return sbxFetch('/api/v1/hub/check_ip', params, 'GET');
}

async function callReport(params) {
    return sbxFetch('/api/v1/hub/report', params, 'GET');
}

async function callSetEnabled(params) {
    return sbxFetch('/api/v1/hub/set_enabled', params, 'POST');
}

async function callSetApiKey(params) {
    return sbxFetch('/api/v1/hub/set_api_key', params, 'POST');
}

async function callGetConfig(params) {
    return sbxFetch('/api/v1/hub/get_config', params, 'GET');
}

async function callLogs(params) {
    return sbxFetch('/api/v1/hub/logs', params, 'GET');
}
