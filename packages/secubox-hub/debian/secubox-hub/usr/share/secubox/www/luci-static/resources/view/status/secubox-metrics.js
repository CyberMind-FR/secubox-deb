...
async function callGetSystemOverview(params) {
    return sbxFetch('/api/v1/hub/get_system_overview', params, 'GET');
}

async function callGetVisitStats(params) {
    return sbxFetch('/api/v1/hub/get_visit_stats', params, 'GET');
}

async function callGetActiveSessions(params) {
    return sbxFetch('/api/v1/hub/get_active_sessions', params, 'GET');
}
