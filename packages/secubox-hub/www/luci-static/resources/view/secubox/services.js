...
async function callListServices(params) {
    return sbxFetch('/api/v1/hub/list_services', params, 'GET');
}
async function callGenerateLanding(params) {
    return sbxFetch('/api/v1/hub/generate_landing_page', params, 'POST');
}
async function callGetServices(params) {
    return sbxFetch('/api/v1/hub/get_services', params, 'GET');
}
async function callGetNetworkInfo(params) {
    return sbxFetch('/api/v1/hub/get_network_info', params, 'GET');
}
async function callCheckAllHealth(params) {
    return sbxFetch('/api/v1/hub/check_all_health', params, 'GET');
}
