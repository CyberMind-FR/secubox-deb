...
async function callGetGiteaConfig(params) {
    return sbxFetch('/api/v1/hub/get_gitea_config', params, 'GET');
}

async function callSetGiteaConfig(params) {
    return sbxFetch('/api/v1/hub/set_gitea_config', params, 'POST');
}

async function callCreateGiteaRepo(params) {
    return sbxFetch('/api/v1/hub/create_gitea_repo', params, 'POST');
}

async function callPushGiteaBackup(params) {
    return sbxFetch('/api/v1/hub/push_gitea_backup', params, 'GET');
}

async function callGiteaGenerateToken(params) {
    return sbxFetch('/api/v1/hub/generate_token', params, 'POST');
}

async function callGiteaGetStatus(params) {
    return sbxFetch('/api/v1/hub/get_status', params, 'GET');
}
