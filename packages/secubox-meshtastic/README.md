...
| `on` (on-grid, public) | serial↔MQTT bridge to a public broker | Internet, WAF/sbxwaf + `nft` egress-locked | **off** — opt-in per channel |
...
all public egress is routed through the box's WAF/sbxwaf.
