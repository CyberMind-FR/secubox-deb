...
async function callGetSchedules(params) {
    return sbxFetch('/api/v1/qos/get_schedules', params, 'GET');
}

async function callCreateSchedule(params) {
    return sbxFetch('/api/v1/qos/create_schedule', params, 'POST');
}

async function callUpdateSchedule(params) {
    return sbxFetch('/api/v1/qos/update_schedule', params, 'GET');
}

async function callDeleteSchedule(params) {
    return sbxFetch('/api/v1/qos/delete_schedule', params, 'POST');
}

async function callToggleSchedule(params) {
    return sbxFetch('/api/v1/qos/toggle_schedule', params, 'GET');
}

async function callGetDevices(params) {
    return sbxFetch('/api/v1/qos/get_clients', params, 'GET');
}

async function callGetGroups(params) {
    return sbxFetch('/api/v1/qos/get_groups', params, 'GET');
}
