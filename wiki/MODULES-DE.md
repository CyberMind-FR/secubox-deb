...
| 🔐 **Authelia SSO** | Access | Single-Sign-On-Identitätsanbieter (AUTH-BRIDGE) |
...
Single-Sign-On-Identitätsanbieter (AUTH-BRIDGE)

**Funktionen:** SSO, 2FA / TOTP, Zugriffsrichtlinien, LDAP-/Datei-Backend
