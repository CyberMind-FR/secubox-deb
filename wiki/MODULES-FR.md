...
| 🔍 **sbxwaf** | Security | Inspection trafic et proxy WAF avec auto-ban |
...
| 🥾 **Démarrage réseau** | System | Provisioning netboot HTTP/TFTP + installeur FIT signé (Tow-Boot) |
